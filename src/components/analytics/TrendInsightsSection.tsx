  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        {data.overview && (
          <div>
            <p className="t-secondary leading-relaxed">{data.overview}</p>
          </div>
        )}
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {data.top_hashtags.map((tag, i) => (
                  <Badge key={i} variant="outline" className="t-label">
                    #{tag}
                  </Badge>
                ))}
              </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {data.opportunities_for_client.map((opp, i) => (
                <div key={i} className="t-secondary bg-[rgba(255,255,255,0.04)] p-2.5 rounded-md leading-relaxed">
                  {opp}
                </div>
              ))}
            </div>
        ...
        {data.successful_formats && data.successful_formats.length > 0 && (
          <div className="space-y-2">
            <h4 className="t-body font-medium">What's Working</h4>
            <div className="flex flex-wrap gap-1.5">
